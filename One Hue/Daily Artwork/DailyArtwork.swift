...
extension Artwork {
    ...
    /// 279 artworks ordered chronologically (Jan → Dec).
    ...
    static let catalog: [Artwork] = [
        ...
        Artwork(id: "ermineSnow",         fileName: "ermineSnow",         displayName: "Ermine in Snow",         completionMessage: "The smallest hunter wears the whitest coat.",                                   month: 1,  day: 2),
        ...
        Artwork(id: "frozenWaterfall",   fileName: "frozenWaterfall",   displayName: "Frozen Waterfall",       completionMessage: "Even falling water learns to hold still when winter asks.",                     month: 1,  day: 8),
        ...
        Artwork(id: "wolfPackTrail",     fileName: "wolfPackTrail",     displayName: "Wolf Pack Trail",        completionMessage: "The pack moves as one because the snow is deep and the night is long.",        month: 1,  day: 11),
        ...
        Artwork(id: "cozyCabinSmoke",    fileName: "cozyCabinSmoke",    displayName: "Cabin Smoke",            completionMessage: "The chimney speaks in gray curls to a sky that always listens.",                month: 1,  day: 14),
        ...
        Artwork(id: "snowMonkeys",         fileName: "snowMonkeys",         displayName: "Snow Monkeys",           completionMessage: "The warmest bond is forged where the cold can't reach.",                       month: 1,  day: 18),
        Artwork(id: "arcticFoxSnow",      fileName: "arcticFoxSnow",      displayName: "Arctic Fox in Snow",     completionMessage: "The fox sleeps deepest where the snow erases all paths.",                       month: 1,  day: 19),
        ...
        Artwork(id: "mooseAtTwilight",   fileName: "mooseAtTwilight",   displayName: "Moose at Twilight",      completionMessage: "The biggest silhouette moves softest through the purple hour.",                 month: 1,  day: 23),
        ...
        Artwork(id: "snowLeopard",         fileName: "snowLeopard",         displayName: "Snow Leopard",           completionMessage: "The ghost of the mountain moves without leaving a trace.",                      month: 1,  day: 25),
        Artwork(id: "barnOwlHunting",    fileName: "barnOwlHunting",    displayName: "Barn Owl Hunting",       completionMessage: "The silent wings read the snow like a letter from the field.",                  month: 1,  day: 26),
        Artwork(id: "wolfHowling",        fileName: "wolfHowling",        displayName: "Wolf Howling",           completionMessage: "The howl doesn't ask for an answer. It just fills the silence.",               month: 1,  day: 27),
        ...
        Artwork(id: "chineseNewYearDragon",fileName:"chineseNewYearDragon",displayName:"Chinese New Year Dragon",completionMessage: "The dragon dances because the new year needs reminding that joy is loud.",     month: 1,  day: 29),
        Artwork(id: "lighthouseCliffs",  fileName: "lighthouseCliffs",   displayName: "Lighthouse Cliffs",      completionMessage: "The light holds steady because the storm never asked permission.",             month: 1,  day: 30),
        Artwork(id: "polarBearMother",   fileName: "polarBearMother",   displayName: "Polar Bear Mother",      completionMessage: "The smallest paws follow the largest across the endless white.",               month: 1,  day: 31),
        ...
        Artwork(id: "snowyGreenhouseGlow",fileName:"snowyGreenhouseGlow",displayName:"Snowy Greenhouse Glow", completionMessage: "The glass keeps summer alive while the snow pretends it doesn't notice.",         month: 2,  day: 14),
        Artwork(id: "lynxSnowfall",      fileName: "lynxSnowfall",      displayName: "Lynx in Snowfall",       completionMessage: "The tufted ears hear the snow before it lands.",                                month: 2,  day: 15),
        ...
        Artwork(id: "icicleCave",        fileName: "icicleCave",        displayName: "Icicle Cave",            completionMessage: "The cave hangs its chandeliers for whoever dares to enter.",                    month: 2,  day: 18),
        ...
        Artwork(id: "lighthouseWaves",   fileName: "lighthouseWaves",    displayName: "Lighthouse in the Rain", completionMessage: "The rain falls on the lighthouse the same as everywhere — and the light stays on.", month: 2, day: 28),
        ...
        Artwork(id: "origamiCranes",      fileName: "origamiCranes",      displayName: "Origami Cranes",         completionMessage: "A thousand folds carry a single wish into the sky.",                           month: 3,  day: 2),
        Artwork(id: "steampunkAirship",  fileName: "steampunkAirship",   displayName: "Steampunk Airship",      completionMessage: "The brass catches the last light because it was built to fly toward it.",       month: 3,  day: 3),
        ...
        Artwork(id: "logCabinSmoke",      fileName: "logCabinSmoke",      displayName: "Log Cabin Smoke",        completionMessage: "The chimney draws a slow line between the forest and the sky.",                  month: 3,  day: 11),
        ...
        Artwork(id: "driedFlowerBouquet", fileName: "driedFlowerBouquet", displayName: "Dried Flower Bouquet",   completionMessage: "What fades keeps its shape when someone decides it's still beautiful.",          month: 3,  day: 17),
        ...
        Artwork(id: "frozenWaterfall",   fileName: "frozenWaterfall",    displayName: "Frozen Cascade",        completionMessage: "The water remembers how to fall, even when it's standing still.",              month: 3,  day: 22),
        ...
        Artwork(id: "windowsillBottles",  fileName: "windowsillBottles",  displayName: "Windowsill Bottles",     completionMessage: "The light finds its best colors in what someone almost threw away.",             month: 4,  day: 18),
        ...
        Artwork(id: "carouselHourse",     fileName: "carouselHourse",     displayName: "Carousel Horse",         completionMessage: "It goes in circles and still makes children believe in journeys.",             month: 4,  day: 24),
        ...
        Artwork(id: "greekIsland",        fileName: "greekIsland",        displayName: "Greek Island",           completionMessage: "White walls and blue doors — simplicity is its own architecture.",             month: 6,  day: 8),
        ...
        Artwork(id: "seaStackReflection", fileName: "seaStackReflection", displayName: "Sea Stack Reflection",   completionMessage: "The rock stands alone because the ocean carved everything else away.",           month: 8,  day: 11),
        ...
        Artwork(id: "mistyFjordDawn",     fileName: "mistyFjordDawn",     displayName: "Misty Fjord at Dawn",    completionMessage: "The fog lifts slowly because even the mountains need a quiet morning.",          month: 10, day: 4),
        ...
        Artwork(id: "redFoxAutumn",       fileName: "redFoxAutumn",       displayName: "Red Fox in Autumn",      completionMessage: "The leaves fall and the fox stays — both exactly where they belong.",            month: 10, day: 14),
        ...
        Artwork(id: "birchTreesAutumn",   fileName: "birchTreesAutumn",   displayName: "Birch Trees in Autumn",  completionMessage: "The white bark holds still while everything golden lets go.",                   month: 10, day: 20),
        ...
        Artwork(id: "nightTrainStars",    fileName: "nightTrainStars",    displayName: "Night Train Under Stars",completionMessage: "The train cuts through the dark and the stars watch it go.",                     month: 11, day: 3),
        ...
        Artwork(id: "tabbyCatWindowsill",fileName: "tabbyCatWindowsill",displayName: "Cat on a Windowsill",   completionMessage: "The warmest spot in the house belongs to whoever finds it first.",              month: 11, day: 5),
