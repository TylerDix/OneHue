...
extension Artwork {
    ...
    static let catalog: [Artwork] = [
        ...
        Artwork(id: "wolfSnow",           fileName: "wolfSnow",           displayName: "Wolf in Snow",           completionMessage: "The forest falls silent not from fear, but from respect.",                       month: 12, day: 2),
        ...
        Artwork(id: "windowsillBottles",  fileName: "windowsillBottles",  displayName: "Windowsill Bottles",     completionMessage: "The light finds its best colors in what someone almost threw away.",             month: 12, day: 4),
